...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 15 2017 г., 15:12
...
-- База данных: `03793`
--
CREATE DATABASE `03793` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `03793`;

-- --------------------------------------------------------

--
-- Структура таблицы `aliens`
--
...
--
CREATE DATABASE `database` DEFAULT CHARACTER SET cp1251 COLLATE cp1251_general_ci;
USE `database`;
--
-- База данных: `dove`
--
CREATE DATABASE `dove` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dove`;

-- --------------------------------------------------------

--
-- Структура таблицы `iecoris`
--

CREATE TABLE IF NOT EXISTS `iecoris` (
...
--
-- Дамп данных таблицы `our_user`
--

INSERT INTO `our_user` (`user_id`, `first_name`, `familia`, `phone`, `email`, `username`, `password`, `page`, `date`) VALUES
(1, '', '', '', '', 'admin', '202cb962ac59075b964b07152d234b70', 'nv-study.ru', '2017-03-19 18:43:00'),
(18, '', 'Хивренко', '79222553098', 'hivr12326@gmail.com', 'lolo', 'e10adc3949ba59abbe56e057f20f883e', '/reg2/reg.php', '0000-00-00 00:00:00'),
(23, '', 'Чмо', '79222553098', 'hivrik97@gmail.com', 'wu_wu74', '827ccb0eea8a706c4c34a16891f84e7b', '/reg2/reg.php', '0000-00-00 00:00:00'),
(27, 'bfdbdfbg', 'bdbdfb', 'bfdbgfc', 'bfcbgfcb', 'ttt', '9990775155c3518a0d7917f7780b24aa', '/site2/php/regs.php', '0000-00-00 00:00:00'),
(28, 'xdv x', 'v xdc vdc v', 'zcczsd', 'cxdvdv', 'eee', 'd2f2297d6e829cd3493aa7de4416a18f', '/site2/php/regs.php', '0000-00-00 00:00:00');
...
('def', '03793', 'aliens', 'name', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'surname', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'email', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'date', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'time', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'numbers', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'appearance', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'actions', 8, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'Fang', 9, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', '03793', 'aliens', 'also', 10, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'iecoris', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dove', 'iecoris', 'imy', 2, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'iecoris', 'familia', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'iecoris', 'email', 4, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'iecoris', 'phone', 5, NULL, 'YES', 'varchar', 12, 36, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'iecoris', 'razmer', 6, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'iecoris', 'opisanie', 7, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'user_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'first_name', 2, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'familia', 3, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'phone', 4, NULL, 'NO', 'varchar', 12, 36, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'email', 5, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'username', 6, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'password', 7, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'page', 8, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'our_user', 'date', 9, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'test', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dove', 'test', 'familia', 2, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dove', 'users', 'first_name', 2, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'users', 'second_name', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'users', 'email', 4, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'users', 'phone', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(12)', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'users', 'login', 6, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'dove', 'users', 'password', 7, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
...
('def', 'shop', 'categories', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'categories', 'name', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'categories', 'cat_id', 3, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'product', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'prod_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'qty', 5, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'name', 6, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 's_name', 7, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'address', 8, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'post_index', 9, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'email', 10, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'orders', 'date', 11, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
('def', 'shop', 'orders', 'time', 12, NULL, 'NO', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products1', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products1', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products1', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products1', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products1', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products10', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products10', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products10', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products10', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products10', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products11', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products11', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products11', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products11', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products11', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products12', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products12', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products12', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products12', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products12', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products13', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products13', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products13', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products13', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products13', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products2', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products2', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products2', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products2', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products2', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products3', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products3', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products3', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products3', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products3', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products4', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products4', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products4', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products4', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products4', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products5', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products5', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products5', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products5', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products5', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products6', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products6', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products6', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products6', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products6', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products7', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products7', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products7', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products7', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products7', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products8', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products8', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products8', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products8', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products8', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products9', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'shop', 'products9', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products9', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products9', 'price', 4, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'shop', 'products9', 'cat', 5, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'category', 'id', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'category', 'name', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'category', 'id_cat', 3, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'our_user', 'user_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'usersbd', 'our_user', 'username', 2, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'our_user', 'password', 3, NULL, 'NO', 'varchar', 40, 120, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'our_user', 'page', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'our_user', 'date', 5, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'our_user', 'email', 6, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'our_user', 'foto', 7, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'title', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'image', 4, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'date', 5, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'cat', 6, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'size', 7, NULL, 'NO', 'text', 32767, 65535, NULL, NULL, 'ucs2', 'ucs2_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'kosht', 8, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'paspr', 9, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'product', 'present', 10, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'setting', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'usersbd', 'setting', 'page', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'setting', 'title', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'setting', 'meta_t', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'setting', 'meta_k', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'usersbd', 'setting', 'text', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'text', '', '', 'select,insert,update,references', '');
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '483'),
('HANDLER_READ_KEY', '1337'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '189'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '1031'),
('HANDLER_READ_RND_NEXT', '10043'),
('HANDLER_ROLLBACK', '2'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '15'),
('HANDLER_WRITE', '7019'),
('INNODB_BUFFER_POOL_PAGES_DATA', '260'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '128'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7931'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '8310'),
('INNODB_BUFFER_POOL_READS', '245'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '442'),
('INNODB_DATA_FSYNCS', '110'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8294400'),
('INNODB_DATA_READS', '383'),
('INNODB_DATA_WRITES', '212'),
('INNODB_DATA_WRITTEN', '4261376'),
('INNODB_DBLWR_PAGES_WRITTEN', '128'),
('INNODB_DBLWR_WRITES', '26'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '101'),
('INNODB_LOG_WRITES', '34'),
('INNODB_OS_LOG_FSYNCS', '58'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '54784'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '16'),
('INNODB_PAGES_READ', '244'),
('INNODB_PAGES_WRITTEN', '128'),
...
('INNODB_ROWS_READ', '3516'),
('INNODB_ROWS_UPDATED', '11'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '24314'),
('UPTIME_SINCE_FLUSH_STATUS', '24314');
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'H:\\usr\\local\\mysql-5.5\\share\\'),
...
('PID_FILE', 'H:\\usr\\local\\mysql-5.5\\data\\305cab02.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'H:\\usr\\local\\mysql-5.5\\data\\305cab02.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'H:\\usr\\local\\mysql-5.5\\data\\305cab02.err'),
...
('PLUGIN_DIR', 'H:\\usr\\local\\mysql-5.5\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'H:\\usr\\local\\mysql-5.5\\data\\305cab02-slow.log'),
...
('def', 'dove', 'PRIMARY', 'def', 'dove', 'iecoris', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'dove', 'PRIMARY', 'def', 'dove', 'our_user', 'user_id', 1, NULL, NULL, NULL, NULL),
('def', 'dove', 'PRIMARY', 'def', 'dove', 'test', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'dove', 'PRIMARY', 'def', 'dove', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'shop', 'PRIMARY', 'def', 'shop', 'categories', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'orders', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products1', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products10', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products11', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products12', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products13', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products2', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products3', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products4', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products5', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products6', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products7', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products8', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'shop', 'PRIMARY', 'def', 'shop', 'products9', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'usersbd', 'PRIMARY', 'def', 'usersbd', 'category', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'usersbd', 'PRIMARY', 'def', 'usersbd', 'our_user', 'user_id', 1, NULL, NULL, NULL, NULL),
('def', 'usersbd', 'PRIMARY', 'def', 'usersbd', 'product', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'usersbd', 'id_2', 'def', 'usersbd', 'product', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'usersbd', 'PRIMARY', 'def', 'usersbd', 'setting', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-06-15 10:12:59', '2017-06-15 10:12:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-06-15 10:12:59', NULL, NULL, NULL, '', '', NULL),
('def', '03793', 'aliens', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-02-20 10:40:31', NULL, NULL, NULL, '', '', NULL),
('def', 'dove', 'iecoris', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-05-26 10:16:45', NULL, NULL, NULL, '', '', NULL),
('def', 'dove', 'our_user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 0, '2017-05-26 10:16:45', NULL, NULL, NULL, '', '', NULL),
('def', 'dove', 'test', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-05-26 10:16:45', NULL, NULL, NULL, '', '', NULL),
('def', 'dove', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2017-05-26 10:16:45', NULL, NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 284, 284, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2017-06-15 08:04:40', NULL, NULL, '', '', NULL),
...
('def', 'shop', 'categories', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 28, 376, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'orders', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 48, 288, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 156, 48, 7528, 281474976710655, 4096, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 40, 324, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products10', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 17, 42, 720, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products11', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 41, 376, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products12', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 53, 584, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 52, 420, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 21, 63, 1336, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 58, 648, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products4', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 59, 832, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products5', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 54, 656, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 32, 296, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products7', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 46, 184, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products8', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 35, 140, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'shop', 'products9', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 28, 36, 1012, 281474976710655, 2048, 0, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, NULL, '', '', NULL),
('def', 'usersbd', 'category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2017-03-09 03:39:19', NULL, NULL, NULL, '', '', NULL),
('def', 'usersbd', 'our_user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 1365, 16384, NULL, 0, 0, '2017-03-22 05:29:58', NULL, NULL, NULL, '', '', NULL),
('def', 'usersbd', 'product', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 32768, 0, '2017-03-09 03:39:33', NULL, NULL, NULL, '', '', NULL),
('def', 'usersbd', 'setting', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 0, '2017-02-22 07:06:17', NULL, NULL, NULL, '', '', NULL);
...
(337, 'root', 'localhost:57973', 'dove', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(336, 'root', 'localhost:57972', NULL, 'Sleep', 3, '', NULL);
...
('def', '03793', 'utf8', 'utf8_general_ci', NULL),
('def', 'database', 'cp1251', 'cp1251_general_ci', NULL),
('def', 'dove', 'utf8', 'utf8_general_ci', NULL),
('def', 'mysql', 'utf8', 'utf8_general_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'phpmyadmin', 'utf8', 'utf8_bin', NULL),
('def', 'shop', 'utf8', 'utf8_general_ci', NULL),
('def', 'usersbd', 'utf8', 'utf8_unicode_ci', NULL);
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '8541'),
('INNODB_BUFFER_POOL_READS', '245'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '442'),
('INNODB_DATA_FSYNCS', '110'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '24315'),
('UPTIME_SINCE_FLUSH_STATUS', '24315');
...
('def', 'dove', 'iecoris', 0, 'dove', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dove', 'our_user', 0, 'dove', 'PRIMARY', 1, 'user_id', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dove', 'test', 0, 'dove', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dove', 'users', 0, 'dove', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'shop', 'categories', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 13, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'orders', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 156, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products1', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products10', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 17, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products11', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products12', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products13', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products2', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 21, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products3', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products4', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 14, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products5', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products6', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products7', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products8', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'shop', 'products9', 0, 'shop', 'PRIMARY', 1, 'id', 'A', 28, NULL, NULL, '', 'BTREE', '', ''),
('def', 'usersbd', 'category', 0, 'usersbd', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'usersbd', 'our_user', 0, 'usersbd', 'PRIMARY', 1, 'user_id', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
('def', 'usersbd', 'product', 0, 'usersbd', 'PRIMARY', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'usersbd', 'product', 0, 'usersbd', 'id_2', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'usersbd', 'product', 1, 'usersbd', 'id', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'usersbd', 'setting', 0, 'usersbd', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-06-15 10:13:00', '2017-06-15 10:13:00', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-06-15 10:13:00', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', '03793', 'aliens', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, NULL, '2017-02-20 10:40:31', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dove', 'iecoris', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2017-05-26 10:16:45', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dove', 'our_user', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 8388608, 29, '2017-05-26 10:16:45', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'dove', 'test', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2017-05-26 10:16:45', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dove', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2017-05-26 10:16:45', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 284, 284, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2017-06-15 08:04:40', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
...
('def', 'shop', 'categories', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 13, 28, 376, 281474976710655, 2048, 0, 14, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'orders', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 6, 48, 288, 281474976710655, 2048, 0, 7, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 156, 48, 7528, 281474976710655, 4096, 0, 170, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products1', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 40, 324, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products10', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 17, 42, 720, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products11', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 9, 41, 376, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products12', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 11, 53, 584, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products13', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 52, 420, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products2', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 21, 63, 1336, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products3', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 11, 58, 648, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products4', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 14, 59, 832, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products5', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 12, 54, 656, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products6', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 9, 32, 296, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products7', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 46, 184, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products8', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 35, 140, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'shop', 'products9', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 28, 36, 1012, 281474976710655, 2048, 0, 168, '2016-02-03 09:55:55', '2016-02-03 09:55:55', NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'usersbd', 'category', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 8388608, NULL, '2017-03-09 03:39:19', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'usersbd', 'our_user', 'BASE TABLE', 'InnoDB', 10, 'Compact', 12, 1365, 16384, 0, 0, 8388608, 14, '2017-03-22 05:29:58', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'usersbd', 'product', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 32768, 8388608, 12, '2017-03-09 03:39:33', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'usersbd', 'setting', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 8388608, 6, '2017-02-22 07:06:17', NULL, NULL, 'utf8_unicode_ci', NULL, '', '');
...
('def', 'dove', 'PRIMARY', 'dove', 'iecoris', 'PRIMARY KEY'),
('def', 'dove', 'PRIMARY', 'dove', 'our_user', 'PRIMARY KEY'),
('def', 'dove', 'PRIMARY', 'dove', 'test', 'PRIMARY KEY'),
('def', 'dove', 'PRIMARY', 'dove', 'users', 'PRIMARY KEY'),
...
('def', 'shop', 'PRIMARY', 'shop', 'categories', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'orders', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products1', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products10', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products11', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products12', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products13', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products2', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products3', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products4', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products5', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products6', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products7', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products8', 'PRIMARY KEY'),
('def', 'shop', 'PRIMARY', 'shop', 'products9', 'PRIMARY KEY'),
('def', 'usersbd', 'PRIMARY', 'usersbd', 'category', 'PRIMARY KEY'),
('def', 'usersbd', 'PRIMARY', 'usersbd', 'our_user', 'PRIMARY KEY'),
('def', 'usersbd', 'PRIMARY', 'usersbd', 'product', 'PRIMARY KEY'),
('def', 'usersbd', 'id_2', 'usersbd', 'product', 'UNIQUE'),
('def', 'usersbd', 'PRIMARY', 'usersbd', 'setting', 'PRIMARY KEY');
...
('root', '[{"db":"usersbd","table":"product"},{"db":"usersbd","table":"category"},{"db":"dove","table":"our_user"},{"db":"dove","table":"users"},{"db":"usersbd","table":"our_user"},{"db":"dove","table":"iecoris"},{"db":"usersbd","table":"setting"},{"db":"03793","table":"aliens"}]');
...
('root', '2016-02-03 09:54:12', '{"lang":"ru"}');
--
-- База данных: `shop`
--
...
(2, 'Вторые блюда', 'Pb2'),
(3, 'Шашлыки', 'Sh'),
(4, 'Холодные закуски', 'H'),
(5, 'Салаты', 'Sa'),
(6, 'Соусы', 'So'),
(7, 'Хлеб', 'Hl'),
(8, 'Сладости к чаю', 'Slad'),
(9, 'Напитки', 'Na'),
(10, 'Водка', 'Vo'),
(11, 'Коньяк', 'Can'),
(12, 'Вино', 'Vin'),
...
INSERT INTO `orders` (`id`, `product`, `prod_id`, `price`, `qty`, `name`, `s_name`, `address`, `post_index`, `email`, `date`, `time`) VALUES
(1, 'Бозбаш', 1, '150.00', '1', '', '', '', '', '', '2016-02-03', '13:40:51'),
(2, 'Душа монаха ', 145, '600.00', '1', '', '', '', '', '', '2016-02-03', '13:40:51'),
(3, 'Бозбаш', 1, '150.00', '1', '', '', '', '', '', '2016-02-03', '13:40:59'),
(4, 'Душа монаха ', 145, '600.00', '1', '', '', '', '', '', '2016-02-03', '13:40:59'),
(5, 'Бозбаш', 1, '150.00', '1', '', '', '', '', '', '2016-02-03', '13:42:45'),
(6, 'Душа монаха ', 145, '600.00', '1', '', '', '', '', '', '2016-02-03', '13:42:45');
...
INSERT INTO `products` (`id`, `title`, `description`, `price`, `cat`) VALUES
(1, 'Бозбаш', '300 гр.', '150.00', 'pb1'),
(2, 'Партлама', '300 гр.', '150.00', 'pb1'),
(3, 'Пити', '300 гр.', '150.00', 'pb1'),
(4, 'Лагман', '300 гр.', '120.00', 'pb1'),
(5, 'Суп лапша', '300 гр.', '100.00', 'pb1'),
(6, 'Борщ', '300 гр.', '70.00', 'pb1'),
(7, 'Солянка', '250 гр.', '120.00', 'pb1'),
(8, 'Уха', '250 гр.', '150.00', 'pb1'),
(9, 'Голубцы', '200 гр.', '130.00', 'pb2'),
(10, 'Манты', '200 гр.', '120.00', 'pb2'),
(11, 'САЦ', '1,1 кг.', '1000.00', 'pb2'),
(12, 'Плов по узбекски', '200 гр.', '120.00', 'pb2'),
(13, 'Долма из виноградных листьев', '200 гр.', '180.00', 'pb2'),
(14, 'Форель жаренная с карт.дольками', '250 гр.', '200.00', 'pb2'),
(15, 'САЦ в ассортименте', '1,2 кг.', '1700.00', 'pb2'),
(16, 'Котлеты по киевски с карт.пюре', '250 гр.', '200.00', 'pb2'),
(17, 'Лангет в ассортименте', '200 гр.', '250.00', 'pb2'),
(18, 'Чыгртма куриная', '200 гр.', '150.00', 'pb2'),
(19, 'Тобака', '1,2 кг.', '350.00', 'pb2'),
(20, 'Яйцо жаренное с помидорами', '200 гр.', '80.00', 'pb2'),
(21, 'Фасоль по азербайджански', '200 гр.', '100.00', 'pb2'),
(22, 'Отбивная мясная с гарниром', '250 гр.', '270.00', 'pb2'),
(23, 'Семга по царски', '270 гр.', '300.00', 'pb2'),
(24, 'Мясо по французски', '300 гр.', '300.00', 'pb2'),
(25, 'Тоба кебаб', '200 гр.', '150.00', 'pb2'),
(26, 'Фаршированная рыба', '1,7 кг.', '3000.00', 'pb2'),
(27, 'Семга жаренная в вине с овощами', '300 гр.', '300.00', 'pb2'),
(28, 'Тушеные овощи', '300 гр.', '150.00', 'pb2'),
(29, 'Картофель фри', '300 гр.', '70.00', 'pb2'),
(30, 'Свинина', '200 гр.', '150.00', 'Sh'),
(31, 'Баранина свежая', '200 гр.', '200.00', 'Sh'),
(32, 'Крылья куриные', '200 гр.', '130.00', 'Sh'),
(33, 'Люля-кебаб', '200 гр.', '200.00', 'Sh'),
(34, 'Из семги', '200 гр.', '250.00', 'Sh'),
(35, 'Говядина', '200 гр.', '200.00', 'Sh'),
(36, 'Картофель печеный на огне', '200 гр.', '70.00', 'Sh'),
(37, 'Перец печеный на огне', '1 шт.', '70.00', 'Sh'),
(38, 'Помидор печеный на огне', '1 шт.', '60.00', 'Sh'),
(39, 'Баклажан печеный на огне', '1 шт.', '80.00', 'Sh'),
(40, 'Из внутренностей баранины', '200 гр.', '200.00', 'Sh'),
(41, 'Овощная нарезка свежая', '200 гр.', '100.00', 'H'),
(42, 'Мясная нарезка ассорти', '200 гр.', '320.00', 'H'),
(43, 'Домашнее соленое ассорти', '200 гр.', '100.00', 'H'),
(44, 'Сырное ассорти', '200 гр.', '180.00', 'H'),
(45, 'Сыр с зеленью', '200 гр.', '150.00', 'H'),
(46, 'Соленые грузди', '150 гр.', '150.00', 'H'),
(47, '"Пантеска"', '160 гр.', '150.00', 'H'),
(48, 'Рулет с корейской морковью', '1 шт.', '20.00', 'H'),
(49, 'Бутерброд с красной икрой', '1 шт.', '50.00', 'H'),
(50, 'Зелень', '100 гр.', '100.00', 'H'),
(51, 'Лимон', '70 гр.', '50.00', 'H'),
(52, 'Маслины - Оливки', '100 гр.', '100.00', 'H'),
(53, 'Тарталетка с мясом и грибами', '1 шт.', '30.00', 'H'),
(54, 'Тарталетка с икрой', '1 шт.', '30.00', 'H'),
(56, '"Фламинго"', '200 гр.', '150.00', 'Sa'),
(57, '"Царский"', '200 гр.', '200.00', 'Sa'),
(58, '"Восторг"', '200 гр.', '150.00', 'Sa'),
(59, '"Чудо Птица"', '200 гр.', '120.00', 'Sa'),
(60, '"Цезарь классический"', '200 гр.', '200.00', 'Sa'),
(61, '"Цезарь морской с семгой"', '200 гр.', '250.00', 'Sa'),
(62, '"Цезарь морской с креветками"', '200 гр.', '300.00', 'Sa'),
(63, '"Куриный салат"', '200 гр.', '150.00', 'Sa'),
(64, '"Миледи"', '200 гр.', '150.00', 'Sa'),
(65, '"Горячий салат"', '200 гр.', '200.00', 'Sa'),
(66, '"Греческий"', '200 гр.', '150.00', 'Sa'),
(67, '"Под шубой"', '200 гр.', '150.00', 'Sa'),
(68, 'Аджика', '', '50.00', 'So'),
(69, 'Майонез', '', '20.00', 'So'),
(70, 'Кетчуп', '', '10.00', 'So'),
(71, 'Белый соус', '', '30.00', 'So'),
(72, 'Наршараб', '', '60.00', 'So'),
(73, 'Соевый соус', '', '20.00', 'So'),
(74, 'Барбекю', '', '50.00', 'So'),
(75, 'Красный соус', '', '50.00', 'So'),
(76, 'Сузма', '', '60.00', 'So'),
(77, 'Лаваш', '250 гр.', '20.00', 'Hl'),
(78, 'Лепешка узбекская', '1 шт.', '20.00', 'Hl'),
(79, 'Самса', '1 шт.', '50.00', 'Hl'),
(80, 'Черный хлеб', '1 шт.', '20.00', 'Hl'),
(81, 'Пахлава', '', '70.00', 'Slad'),
(82, 'Шикэрбра', '', '60.00', 'Slad'),
(83, 'Бадамбра', '', '70.00', 'Slad'),
(84, 'Шоргогал', '', '35.00', 'Slad'),
(85, 'Нарзан ', '0,5л.', '100.00', 'Na'),
(86, 'Ричал су', '0,5л.', '100.00', 'Na'),
(87, 'Бон Аква', '0,5л.', '70.00', 'Na'),
(88, 'Бон Аква', '1,0л', '100.00', 'Na'),
(89, 'Сок натуральный ', '0,5л.', '110.00', 'Na'),
(90, 'Сок натуральный', '1ст.', '30.00', 'Na'),
(91, 'Сок гранатовый ', '1,0л', '150.00', 'Na'),
(92, 'Coca-Cola', '0,5л', '70.00', 'Na'),
(93, 'Coca-Cola', '1,0л.', '110.00', 'Na'),
(94, 'Fanta', '0,5л.', '70.00', 'Na'),
(95, 'Fanta', '1,0л.', '110.00', 'Na'),
(96, 'Sprite', '0,5л.', '70.00', 'Na'),
(97, 'Sprite', '1,0л.', '110.00', 'Na'),
(98, 'Schwepps', '0,5л.', '70.00', 'Na'),
(99, 'Schwepps', '1,0л.', '110.00', 'Na'),
(100, 'Морс', '1,0л.', '130.00', 'Na'),
(101, 'Морс', '1ст.', '40.00', 'Na'),
(102, 'Компот', '1,0л.', '150.00', 'Na'),
(103, 'Компот', '1ст.', '50.00', 'Na'),
(104, 'Айран', '1,0л.', '150.00', 'Na'),
(105, 'Довка', '1,0л.', '200.00', 'Na'),
(106, 'Довка', '1ст.', '60.00', 'Na'),
(107, 'Coffe Cola', '', '120.00', 'Na'),
(108, 'Red bull', '0,33л', '120.00', 'Na'),
(109, 'Red bull', '0,5л.', '150.00', 'Na'),
(110, 'Burn', '0,33л', '120.00', 'Na'),
(111, 'Burn', '0,5л.', '150.00', 'Na'),
(112, 'Adrenalin ', '0,5л.', '130.00', 'Na'),
(115, 'Drova', '0,5л.', '600.00', 'Vo'),
(116, 'Moskovskaya ', '0,5л.', '600.00', 'Vo'),
(117, 'Stolichnaya ', '0,5л.', '600.00', 'Vo'),
(118, 'Зеленая марка ', '0,5л.', '650.00', 'Vo'),
(119, 'Югра ', '0,5л.', '650.00', 'Vo'),
(120, 'Журавли ', '0,5л.', '650.00', 'Vo'),
(121, 'Parlament ', '0,5л.', '700.00', 'Vo'),
(122, 'Кедровица ', '0,5л.', '700.00', 'Vo'),
(123, 'Gold ', '0,5л.', '700.00', 'Vo'),
(124, 'Мерная ', '0,5л.', '700.00', 'Vo'),
(125, 'Снежная королева ', '0,5л.', '800.00', 'Vo'),
(126, 'Березовые бруньки ', '0,5л.', '800.00', 'Vo'),
(127, 'Graf Ledoff Light  ', '0,5л.', '800.00', 'Vo'),
(128, 'Царская ', '0,5л.', '1000.00', 'Vo'),
(129, 'Русский Стандарт ', '0,5л.', '1000.00', 'Vo'),
(130, 'Кристалл', '0,5л.', '1000.00', 'Vo'),
(131, 'Белюга ', '0,5л.', '1500.00', 'Vo'),
(135, 'Лезгинка ', '0,5л.', '1000.00', 'Can'),
(136, 'Дагестанская ', '0,5л.', '1200.00', 'Can'),
(137, 'Кызляр ', '0,5л.', '1200.00', 'Can'),
(138, 'Арарат ', '0,5л.', '1200.00', 'Can'),
(139, 'Старейшина ', '0,5л.', '1200.00', 'Can'),
(140, 'Ной ', '0,5л.', '1200.00', 'Can'),
(141, 'Армения', '0,5л.', '1500.00', 'Can'),
(142, 'Черный парус ', '1500', '1500.00', 'Can'),
(143, 'Henesy ', '0,5л.', '3500.00', 'Can'),
(145, 'Душа монаха ', '0,7л.', '600.00', 'Vin'),
(146, 'August Weinxof ', '0,7л.', '700.00', 'Vin'),
(147, 'Монастырская трапеза ', '0,7л.', '700.00', 'Vin'),
(148, 'Монашеский орден ', '0,7л.', '700.00', 'Vin'),
(149, 'Martini ', '0,7л.', '700.00', 'Vin'),
(150, 'Гранатовый браслет кр. п/c ', '0,7л.', '800.00', 'Vin'),
(151, 'Klaus Langhoff бел. п/c  ', '0,7л.', '800.00', 'Vin'),
(152, 'Le Chabrot бел. п/с', '0,7л.', '800.00', 'Vin'),
(153, 'Asura ', '0,7л.', '800.00', 'Vin'),
(154, 'Шампанское советское ', '0,7л.', '800.00', 'Vin'),
(155, 'Carlo Rossi роз. п/с ', '0,7л.', '1000.00', 'Vin'),
(160, 'Балтика "0" ', '0,5л.', '100.00', 'Pv'),
(161, 'Сибирская корона:  золотистое/оригинальное/классическое', '0,5л.', '110.00', 'Pv'),
(162, 'Bud ', '0,5л.', '120.00', 'Pv'),
(163, 'Staropramen ', '0,5л.', '120.00', 'Pv'),
(164, 'Клинское светлое ', '0,5л.', '100.00', 'Pv'),
(165, 'Чешское', '0,5л.', '90.00', 'Pv'),
(166, 'Золотой титул ', '0,5л.', '90.00', 'Pv'),
(167, 'Lowenbrau ', '0,5л.', '100.00', 'Pv');
...
INSERT INTO `products1` (`id`, `title`, `description`, `price`, `cat`) VALUES
(1, 'Бозбаш', '300 гр.', '150.00', 'pb1'),
(2, 'Партлама', '300 гр.', '150.00', 'pb1'),
(3, 'Пити', '300 гр.', '150.00', 'pb1'),
(4, 'Лагман', '300 гр.', '120.00', 'pb1'),
...
--
-- Дамп данных таблицы `products10`
--

INSERT INTO `products10` (`id`, `title`, `description`, `price`, `cat`) VALUES
(115, 'Drova', '0,5л.', '600.00', 'Vo'),
(116, 'Moskovskaya ', '0,5л.', '600.00', 'Vo'),
(117, 'Stolichnaya ', '0,5л.', '600.00', 'Vo'),
(118, 'Зеленая марка ', '0,5л.', '650.00', 'Vo'),
...
--
-- Структура таблицы `products11`
--

CREATE TABLE IF NOT EXISTS `products11` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `description` text NOT NULL,
  `price` decimal(8,2) NOT NULL,
...
--
-- Дамп данных таблицы `products11`
--

INSERT INTO `products11` (`id`, `title`, `description`, `price`, `cat`) VALUES
(135, 'Лезгинка ', '0,5л.', '1000.00', 'Can'),
(136, 'Дагестанская ', '0,5л.', '1200.00', 'Can'),
(137, 'Кызляр ', '0,5л.', '1200.00', 'Can'),
(138, 'Арарат ', '0,5л.', '1200.00', 'Can'),
...
--
-- Дамп данных таблицы `products12`
--

INSERT INTO `products12` (`id`, `title`, `description`, `price`, `cat`) VALUES
(145, 'Душа монаха ', '0,7л.', '600.00', 'Vin'),
(146, 'August Weinxof ', '0,7л.', '700.00', 'Vin'),
(147, 'Монастырская трапеза ', '0,7л.', '700.00', 'Vin'),
(148, 'Монашеский орден ', '0,7л.', '700.00', 'Vin'),
...
--
-- Структура таблицы `products13`
--

CREATE TABLE IF NOT EXISTS `products13` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `description` text NOT NULL,
  `price` decimal(8,2) NOT NULL,
...
--
-- Дамп данных таблицы `products13`
--

INSERT INTO `products13` (`id`, `title`, `description`, `price`, `cat`) VALUES
(160, 'Балтика "0" ', '0,5л.', '100.00', 'Pv'),
(161, 'Сибирская корона:  золотистое/оригинальное/классическое', '0,5л.', '110.00', 'Pv'),
(162, 'Bud ', '0,5л.', '120.00', 'Pv'),
(163, 'Staropramen ', '0,5л.', '120.00', 'Pv'),
...
INSERT INTO `products2` (`id`, `title`, `description`, `price`, `cat`) VALUES
(9, 'Голубцы', '200 гр.', '130.00', 'pb2'),
(10, 'Манты', '200 гр.', '120.00', 'pb2'),
(11, 'САЦ', '1,1 кг.', '1000.00', 'pb2'),
(12, 'Плов по узбекски', '200 гр.', '120.00', 'pb2'),
...
--
-- Дамп данных таблицы `products3`
--

INSERT INTO `products3` (`id`, `title`, `description`, `price`, `cat`) VALUES
(30, 'Свинина', '200 гр.', '150.00', 'Sh'),
(31, 'Баранина свежая', '200 гр.', '200.00', 'Sh'),
(32, 'Крылья куриные', '200 гр.', '130.00', 'Sh'),
(33, 'Люля-кебаб', '200 гр.', '200.00', 'Sh'),
...
--
-- Дамп данных таблицы `products4`
--

INSERT INTO `products4` (`id`, `title`, `description`, `price`, `cat`) VALUES
(41, 'Овощная нарезка свежая', '200 гр.', '100.00', 'H'),
(42, 'Мясная нарезка ассорти', '200 гр.', '320.00', 'H'),
(43, 'Домашнее соленое ассорти', '200 гр.', '100.00', 'H'),
(44, 'Сырное ассорти', '200 гр.', '180.00', 'H'),
...
--
-- Дамп данных таблицы `products5`
--

INSERT INTO `products5` (`id`, `title`, `description`, `price`, `cat`) VALUES
(56, '"Фламинго"', '200 гр.', '150.00', 'Sa'),
(57, '"Царский"', '200 гр.', '200.00', 'Sa'),
(58, '"Восторг"', '200 гр.', '150.00', 'Sa'),
(59, '"Чудо Птица"', '200 гр.', '120.00', 'Sa'),
...
--
-- Дамп данных таблицы `products6`
--

INSERT INTO `products6` (`id`, `title`, `description`, `price`, `cat`) VALUES
(68, 'Аджика', '', '50.00', 'So'),
(69, 'Майонез', '', '20.00', 'So'),
(70, 'Кетчуп', '', '10.00', 'So'),
(71, 'Белый соус', '', '30.00', 'So'),
...
--
-- Дамп данных таблицы `products7`
--

INSERT INTO `products7` (`id`, `title`, `description`, `price`, `cat`) VALUES
(77, 'Лаваш', '250 гр.', '20.00', 'Hl'),
(78, 'Лепешка узбекская', '1 шт.', '20.00', 'Hl'),
(79, 'Самса', '1 шт.', '50.00', 'Hl'),
(80, 'Черный хлеб', '1 шт.', '20.00', 'Hl');
...
--
-- Структура таблицы `products8`
--

CREATE TABLE IF NOT EXISTS `products8` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `description` text NOT NULL,
  `price` decimal(8,2) NOT NULL,
...
--
-- Дамп данных таблицы `products8`
--

INSERT INTO `products8` (`id`, `title`, `description`, `price`, `cat`) VALUES
(81, 'Пахлава', '', '70.00', 'Slad'),
(82, 'Шикэрбра', '', '60.00', 'Slad'),
(83, 'Бадамбра', '', '70.00', 'Slad'),
(84, 'Шоргогал', '', '35.00', 'Slad');
...
--
-- Структура таблицы `products9`
--

CREATE TABLE IF NOT EXISTS `products9` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `description` text NOT NULL,
  `price` decimal(8,2) NOT NULL,
...
--
-- Дамп данных таблицы `products9`
--

INSERT INTO `products9` (`id`, `title`, `description`, `price`, `cat`) VALUES
(85, 'Нарзан ', '0,5л.', '100.00', 'Na'),
(86, 'Ричал су', '0,5л.', '100.00', 'Na'),
(87, 'Бон Аква', '0,5л.', '70.00', 'Na'),
(88, 'Бон Аква', '1,0л', '100.00', 'Na'),
...
-- База данных: `usersbd`
--
CREATE DATABASE `usersbd` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `usersbd`;
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `id_cat` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `category` (`id`, `name`, `id_cat`) VALUES
(1, 'Одежда', '1'),
(2, 'Обувь', '2');
...
INSERT INTO `our_user` (`user_id`, `username`, `password`, `page`, `date`, `email`, `foto`) VALUES
(1, 'admin', '202cb962ac59075b964b07152d234b70', 'nv-study.ru', '2017-03-19 18:43:00', 'dfgdf', 'pict1.jpg'),
(3, '152', '202cb962ac59075b964b07152d234b70', '/reg/reg.php', '0000-00-00 00:00:00', 'saffss', 'pict2.jpg'),
(4, 'амв', '202cb962ac59075b964b07152d234b70', '/reg/reg.php', '0000-00-00 00:00:00', 'sefse', 'pict3.jpg'),
(5, 'fff', '250cf8b51c773f3f8dc8b4be867a9a02', '/reg/reg.php', '0000-00-00 00:00:00', 'hrhyr', 'pict4.jpg'),
(6, 'iii', '202cb962ac59075b964b07152d234b70', '/reg/reg.php', '0000-00-00 00:00:00', 'hrthrd', 'pict3.jpg'),
(7, '147', '8d5e957f297893487bd98fa830fa6413', '/reg/reg.php', '0000-00-00 00:00:00', '6u66uy', 'pict1.jpg'),
(8, '147', '8d5e957f297893487bd98fa830fa6413', '/reg/reg.php', '0000-00-00 00:00:00', 'ij6t7u', 'pict2.jpg'),
(9, '123', '202cb962ac59075b964b07152d234b70', '/reg/index.php?view=reg', '0000-00-00 00:00:00', '7jut6uj', 'pict3.jpg'),
(10, '459', '7fe1f8abaad094e0b5cb1b01d712f708', '/superpuper/index.php?view=reg', '0000-00-00 00:00:00', '', ''),
(11, '789', '250cf8b51c773f3f8dc8b4be867a9a02', '/superpuper/index.php?view=reg', '0000-00-00 00:00:00', '', ''),
(12, 'iii', '36347412c7d30ae6fde3742bbc4f21b9', '/superpuper/index.php?view=reg', '0000-00-00 00:00:00', '', ''),
(13, 'yyy', 'f0a4058fd33489695d53df156b77c724', '/superpuper/index.php?view=reg', '0000-00-00 00:00:00', '', '');
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `size` text CHARACTER SET ucs2 COLLATE ucs2_unicode_ci NOT NULL,
  `kosht` float NOT NULL,
  `paspr` tinyint(1) NOT NULL,
...
INSERT INTO `product` (`id`, `title`, `description`, `image`, `date`, `cat`, `size`, `kosht`, `paspr`, `present`) VALUES
(1, 'Ботинки осенние', 'Женские осенние ботинки помогут собственный, неповторимый образ, тем самым, выделив из толпы. Какие ботинки в моде на сезон осень-зима 2017-2018', 'pict1.jpg', '2017-06-01 00:00:00', '2', '37-40', 2000, 0, 0),
(2, 'Костюм детский', 'Большой выбор детских спортивных костюмов в интернет-магазине WildBerries.ru. Бесплатная доставка и постоянные скидки!', 'pict2.jpg', '2017-06-04 00:00:00', '1', '22-25', 500, 1, 0),
(3, 'Куртка женская', 'Модные куртки в магазине LAMODA! Примерка. Бесплатная доставка по Иркутску.\r\nУдобный сервисПодлинные брендыБесплатная доставка', 'pict3.jpg', '2017-06-06 00:00:00', '1', '48-50', 2000, 0, 1),
(4, 'Куртка женская зимняя', 'Стильная женская куртка-ветровка (виндстоппер), безупречного качества, мембрана на флисе', 'pict4.jpg', '2017-06-02 00:00:00', '1', '44-48', 1500, 0, 0),
(5, 'Пиджак', 'Женский пиджак представляет собой важнейшую и неотъемлемую составляющую женского гардероба. ... Женский пиджак и его фасоны.', 'pict5.jpg', '2017-06-06 00:00:00', '1', '44-46', 1000, 1, 0),
(6, 'Ботинки замшевые', 'Замшевые мужские ботинки этого сезона отличаются оригинальностью, привлекательностью и уникальным дизайном.', 'pict7.jpg', '2017-06-01 00:00:00', '2', '37-39', 500, 0, 1),
(7, 'Плащ', 'Стильные женские плащи Twin Tip! Беларусь! Новинки 2017. Выбирайте!\r\nДоставка по всей России.', 'pict6.jpg', '2017-06-08 00:00:00', '1', '44-46', 600, 1, 0),
(8, 'Туфли женские', 'Модные лабутены — история становления и секрет популярности этих туфель. Особый шарм образу женщины придает обувь.', 'pict8.jpg', '2017-06-14 00:00:00', '2', '40', 3000, 0, 0);
...
CREATE TABLE IF NOT EXISTS `setting` (
  ...
  `meta_t` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `setting` (`id`, `page`, `title`, `meta_t`, `meta_k`, `text`) VALUES
(1, 'page1', 'Первая страница', 'Первая страница должна содержать название основных разделов, а в основной части - новостную информацию, блоки рекламы и другие полезные ссылки', 'раздел, новость, контент, реклама', '<b>Lorem ipsum или «текстовая рыба»</b> — это жаргонное название бессмысленного текста, чаще всего на латыне, который вставляется в макет сайта, чтобы заполнить текстовую часть макета.\r\nВо время редактирования текстового слоя перейдите по пути Type > Paste Lorem Ipsum в главном меню для того чтобы вставить абзац шаблонного текста. Можно даже назначить этой функции комбинацию клавиш, чтобы делать это еще быстрее.'),
(2, 'page2', 'Вторая страница', 'Типы верстки веб-страницы', 'блочная верстка, табличная верстка', 'Ввиду того,что мы будем создавать простой пятистраничный сайт мы рассмотрим создание сайта без CMS (без движка).Стоит заметить что для создания сайта применяются табличная или блочная верстка.В большинстве случаев для создания применяется и табличная и блочная верстка.Здесь мы будем рассматривать табличную верстку.'),
(3, 'page3', 'Третья страница', 'О сайтах', 'процесс, платежные системы', 'Создание сайта – трудоемкий процесс, который состоит из множества операций, в первую очередь, необходимо наличие счета в платежных системах (Яндекс. Деньги, Вебмани), они понадобятся для оплаты хостинга, домена и других составляющих сайта. Сайт образ...'),
(4, 'page4', 'Четвертая страница', 'Описание хостингов', 'хостинг, сайт', 'Виртуальный хостинг – это одна из самых распространенных услуг размещения сайтов. Виртуальность в этом случае заключается в том, что на одном физическом сервере с уникальным IP-адресом может  размещаться много сайтов. При этом DNS-суффикс указывает на IP-адрес сервера, а  сервер по доменному имени предоставляет доступ к заявленному ресурсу. Сайты представляют собой пользователей сервера со своими домашними директориями, в которых располагаются файлы сайта. Между ними происходит разделение ресурсов аппаратного и программного обеспечения сервера. Кроме того, на сервере работает система управления базами данных,  доступ к которой также входит в услугу виртуального хостинга. Количество места на диске,  доступных сайтов и баз данных на хостинге зависит от конкретного тарифного плана. Виртуальный хостинг  является недорогой услугой и хорошо подойдет небольшим сайтам со средней посещаемостью.'),
(5, 'page5', 'Пятая страница', 'Определение средств для разработки сайта', 'CMS, функции', 'Систе́ма управле́ния содержи́мым (конте́нтом) (англ. Content management system, CMS)[1] — информационная система или компьютерная программа, используемая для обеспечения и организации совместного процесса создания, редактирования и управления содержимым, иначе — контентом (от английского content)[2].\r\nОсновные функции CMS[3]:\r\nПредоставление инструментов для создания содержимого, организация совместной работы над содержимым,\r\nУправление содержимым: хранение, контроль версий, соблюдение режима доступа, управление потоком документов и т. п.,\r\nПубликация содержимого,\r\nПредставление информации в виде, удобном для навигации, поиска.');
